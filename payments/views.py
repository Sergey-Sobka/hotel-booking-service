...
class PaymentSuccessView(APIView):
    @extend_schema(
        ...
        responses={
            200: OpenApiResponse(description="Payment successfully verified and booking updated."),
            400: OpenApiResponse(description="Invalid session or payment not completed."),
        ...
        try:
            ...
            if payment.status != Payment.StatusChoices.PAID:
                ...
                if stripe_session.payment_status != "paid":
                    return Response({"error": "Not paid yet."}, status=status.HTTP_400_BAD_REQUEST)
...
class PaymentCancelView(APIView):
    @extend_schema(
        ...
        responses={200: OpenApiResponse(description="Cancellation message received.")}
    )
    def get(self, request):
        return Response(
...
class PaymentViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    @extend_schema(summary="List payments",
